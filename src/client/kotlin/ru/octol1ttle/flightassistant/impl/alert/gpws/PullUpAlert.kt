...
class PullUpAlert : Alert(), CenteredAlert {
    ...
    override fun shouldActivate(computers: ComputerAccess): Boolean {
        return computers.gpws.groundImpactStatus <= GroundProximityComputer.Status.WARNING
    }

    override fun render(drawContext: DrawContext, computers: ComputerAccess, y: Int): Boolean {
        val flash: Boolean =
            if (computers.gpws.groundImpactStatus == GroundProximityComputer.Status.RECOVER) totalTicks % 10 >= 5
