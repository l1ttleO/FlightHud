    ...
    private ConfigCategory indicators(Text name, IndicatorConfig config, IndicatorConfig defaults) {
        return ConfigCategory.createBuilder()
                ...
                .option(Option.<Boolean>createBuilder()
                        ...
                        .build())
                .option(Option.<Boolean>createBuilder()
                        .name(Text.translatable("config.flightassistant.indicators.info.engine_power"))
                        .binding(defaults.showEnginePower, () -> config.showEnginePower, o -> config.showEnginePower = o)
                        .controller(TickBoxControllerBuilder::create)
                        .build())
                .option(Option.<Boolean>createBuilder()
